...
class ExperimentalMetricsCollector:
    ...
    def compute_acceleration_metrics(self) -> Dict[str, Any]:
        ...
        if len(iteration_stats) >= 2:
            ...
            if len(reductions) >= 2:
                ...
                late_reduction = sum(reductions[len(reductions)//2:]) / (len(reductions) - len(reductions)//2)
        ...
        return {
            ...
            "final_error_reduction": iteration_stats[-1]["avg_error_reduction"] if iteration_stats else None,
        }
    ...
    def load(cls, filepath: str) -> "ExperimentalMetricsCollector":
        ...
        for run_data in data["runs"]:
            ...
            for key in ["noisy_error", "mitigated_error", "error_reduction", "mitigation_efficiency"]:
    ...
    def summary(self) -> str:
        ...
        lines = [
            ...
            f"Final error reduction: {metrics.get('final_error_reduction', 0):.1%}" if metrics.get('final_error_reduction') else "",
            f"",
