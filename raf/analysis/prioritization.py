...
class ResearchPrioritizer:
    ...
    def _adjust_for_framework(self, framework: Any) -> List[InvestmentOpportunity]:
        ...
        for opp in self.opportunities:
            ...
            active_loops = [loop for loop in opp.affected_loops if loop in framework.loops]
            ...
            adjusted_impact = (
                opp.impact_score * loop_factor * (len(active_loops) / len(opp.affected_loops))
            )
    ...
    def compare_strategies(
        ...
        for i, strategy in enumerate(strategies):
            ...
            selected = [o for o in self.opportunities if o.name in strategy]
