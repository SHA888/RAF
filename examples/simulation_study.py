...
from raf.analysis import CrossLoopAnalyzer, ResearchPrioritizer
...
def run_simulation(
    ...
    if scenario == "baseline":
        ...
        ad_params = {"quality_improvement": 0.03, "efficiency_improvement": 0.04, "surrogate_improvement": 0.04}
        cc_params = {"model_improvement": 0.03, "fidelity_improvement": 0.0003, "depth_growth": 1.08}
        ...
        ad_params = {"quality_improvement": 0.04, "efficiency_improvement": 0.08, "surrogate_improvement": 0.08}
        ...
        ad_params = {"quality_improvement": 0.025, "efficiency_improvement": 0.03, "surrogate_improvement": 0.03}
        cc_params = {"model_improvement": 0.05, "fidelity_improvement": 0.0008, "depth_growth": 1.15}
    else:
    ...
    calibration_loop = CalibrationControlLoop(initial_model_accuracy=0.4, initial_gate_fidelity=0.99)
